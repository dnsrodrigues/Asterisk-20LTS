...
#Configurar arquivo no caminho /etc/asterisk extensions.conf no caminho :
[general]
static=yes
writeprotect=no
clearglobalvars=no
...
exten => 1003,1,Dial(PJSIP/1003,30,rtT)
exten => 1003,2,Hangup()
